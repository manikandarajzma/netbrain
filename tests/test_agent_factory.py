...
class AgentFactoryTests(unittest.TestCase):
    ...
    @patch("agents.agent_factory.create_react_agent")
    def test_agent_factory_singleton_builds_minimal_react_agent(self, mock_create_react_agent):
        mock_create_react_agent.return_value = "agent"

        agent = agent_factory.create_specialized_agent("llm", ["tool-a"], "system prompt", "troubleshoot")
