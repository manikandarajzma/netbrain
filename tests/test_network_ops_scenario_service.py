...
class NetworkOpsScenarioServiceTests(unittest.IsolatedAsyncioTestCase):
    ...
    @patch("services.network_ops_scenario_service.agent_scenario_service.select_scenario", new_callable=AsyncMock)
    async def test_select_scenario_returns_model_choice(self, mock_select_scenario):
        mock_select_scenario.return_value = "access_change"
