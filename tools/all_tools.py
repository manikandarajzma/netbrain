...
async def ping_device(
    ...
    Use the first_hop_device from trace_path as the device.
    Use src_vrf from the path trace for the vrf parameter.
    Use first_hop_lan_interface as source_interface for accurate VRF pinging.
